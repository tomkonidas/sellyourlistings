<template>
    <section class="bg-teal-800">
        <div class="max-w-screen-xl mx-auto md:grid md:grid-cols-2 md:px-6 lg:px-8">
            <div class="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-teal-900 lg:pr-16">
            ...
            <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
                ...
                <div class="flex">
                    ...
                    <div class="text-base leading-6 font-medium text-teal-200">CEO, Tuple</div>
                    </div>
                </div>
                </footer>
            </blockquote>
            </div>
            <div class="py-12 px-4 border-t-2 border-teal-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
            <div class="md:flex-shrink-0">
